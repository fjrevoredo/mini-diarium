...
Source: https://mini-diarium.com/docs/import/

## Opening the Import Dialog

Click the **⋮** menu in the header and select **Import...**.

![Import Entries dialog with a format dropdown and a file picker](https://mini-diarium.com/assets/docs/import-01-dialog.webp "The Import Entries dialog")
