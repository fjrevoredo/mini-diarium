...
> Full-text search across every encrypted entry via the search overlay or Ctrl+F, with instant highlighted results, and how it stays fully encrypted and offline.

Source: https://mini-diarium.com/docs/search/
...
![Search overlay with a query and three matching results, each with the matched word highlighted](https://mini-diarium.com/assets/docs/search-01-overlay-results.webp "Searching for 'morning' across the journal")
