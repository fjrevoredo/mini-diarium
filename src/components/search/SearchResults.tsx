  ...
  return (
    <div class="mt-2">
      <Show when={isSearching()}>
        <div class="py-4 text-center text-sm text-gray-500">Searching...</div>
      </Show>
          ...
          <For each={searchResults()}>
            {(result) => (
              <button
                ...
                class="w-full rounded-md p-3 text-left transition-colors hover:bg-gray-100"
              >
                <div class="flex items-start justify-between">
                  <div class="flex-1">
                    <div class="text-sm font-medium text-gray-900">
                      {result.title || <span class="italic text-gray-400">No title</span>}
                    </div>
