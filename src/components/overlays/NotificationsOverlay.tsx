...
function typeBadgeLabel(t: ReturnType<typeof useI18n>, type: NotificationType): string {
          ...
          >
            ...
            <div class="overflow-y-auto max-h-[60vh]">
              <Show
                ...
                fallback={
                  <p class="py-12 text-center text-sm text-secondary">{t('notifications.empty')}</p>
                }
              >
                      ...
                      >
                        ...
                        <div class="flex-1 min-w-0">
                          ...
                          <div class="flex items-center gap-2 mb-1">
                            ...
                            <p class="text-sm font-semibold text-primary truncate">{entry.title}</p>
                          </div>

                          {/* Body */}
                          <p class="text-sm text-secondary mb-2">{entry.body}</p>
