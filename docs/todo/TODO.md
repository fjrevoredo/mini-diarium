...
- [ ] **TODO-0025: Text color, highlight, and underline formatting** — add text color and text highlight (background color) formatting options to the editor toolbar; ensure underline is readily discoverable and accessible either in the basic toolbar by default or via the advanced toolbar toggle
