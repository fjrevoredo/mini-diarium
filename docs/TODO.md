...
- [ ] **TODO system IDs and E2E skill** — add unique identifiers to TODO items in `docs/TODO.md` and create a `.agents/skills/` skill that systematizes end-to-end handling of TODO items (creation, tracking, archival, validation)
