...
/// Applies all pending DDL-only migrations (v3→v4 through v8→v9) in order.
///
...
mod tests {
    ...
    #[test]
    fn test_apply_pending_advances_v3_to_v9() {
        ...
        let version: i32 = db
            ...
            .unwrap();
        assert_eq!(version, 9, "apply_pending must advance schema to v9");
