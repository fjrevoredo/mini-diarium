...
- `.agents/skills/runbooks/skills/diagram-maintainer/scripts/render_diagram_previews.sh`
...
```bash
.agents/skills/runbooks/skills/diagram-maintainer/scripts/render_diagram_previews.sh --out-dir /tmp/diagram-previews
.agents/skills/runbooks/skills/diagram-maintainer/scripts/render_diagram_previews.sh --files docs/diagrams/save-entry.svg docs/diagrams/save-entry-dark.svg
```
